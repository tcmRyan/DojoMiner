...
class GradingPage:
    ...
    def validate_login(self):
        ...
        if self.page.html.find(login_selector, first=True):
            raise EnvironmentError("Browser Not Authenticated")

    @property
    def page_count(self):
        pagination_selector = 'body > div.body-content > div:nth-child(2) > div:nth-child(2) > ul'
    ...
    def table_headers(self):
        ...
        return [header.text if header.text else "Play and Grade" for header in headers_html]
